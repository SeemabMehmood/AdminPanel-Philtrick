...
class DepositsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deposit" do
    assert_difference('Deposit.count') do
      post deposits_url, params: { deposit: { income: @deposit.income, income: @deposit.income, users_id: @deposit.users_id, workers_id: @deposit.workers_id } }
    end
  ...
  test "should update deposit" do
    patch deposit_url(@deposit), params: { deposit: { income: @deposit.income, income: @deposit.income, users_id: @deposit.users_id, workers_id: @deposit.workers_id } }
