...
(function() {
  var draw_linechart, ready, set_chart_data, turboload, turborender;

  ready = function() {
    turboload();
    return draw_linechart();
  };
  ...
  turborender = function() {
    return $.AdminLTE.tree(".sidebar");
  };

  draw_linechart = function() {
    var chart, ctx, data, labels;
